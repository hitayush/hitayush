...
|---|---|---|
| **DialDoctor** | Healthtech platform — built the doctor search feature (symptom-to-specialty matching, location-based search using PostGIS), plus core legal/compliance docs. | Next.js, Supabase, PostgreSQL (pg_trgm, PostGIS) |
| **Academic Tracker** | Production web app for attendance tracking, practicals logging, notes with file uploads, and timetable-based ICS calendar export. | Next.js 14, Supabase |
| **Python Data Dashboard** | Analytics dashboard with real-time chart rendering. | FastAPI, React, Pandas |
...
<div align="center">
  <img src="https://github-profile-trophy.vercel.app/?username=hitayush&theme=tokyonight&no-frame=true&column=7&margin-w=10&margin-h=10" width="100%" />
</div>
